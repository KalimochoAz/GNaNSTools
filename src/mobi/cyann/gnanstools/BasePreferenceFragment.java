...
import mobi.cyann.gnanstools.preference.BasePreference;
import mobi.cyann.gnanstools.preference.RemovablePreferenceCategory;
...
public class BasePreferenceFragment extends PreferenceListFragment implements OnPreferenceAttachedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getActivity().registerReceiver(reloadListener, new IntentFilter("mobi.cyann.gnanstools.RELOAD"));
	}
