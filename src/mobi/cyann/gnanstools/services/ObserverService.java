...
public class ObserverService extends Service {
	private final static String LOG_TAG = "GNaNSTools.ObserverService";
	...
	public static void startService(Context context, boolean forced) {
		...
		boolean startService = preferences.getBoolean(context.getString(R.string.key_gnanstools_service), false);
