...
public class GovernorPreferenceGroup extends RemovablePreferenceCategory {
    ...
    private void init(Context context, AttributeSet attrs) {
    	TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.mobi_cyann_gnanstools_preference_GovernorPreferenceGroup, 0, 0);
		governor = a.getString(R.styleable.mobi_cyann_gnanstools_preference_GovernorPreferenceGroup_governor);
		a.recycle();
		if(blankView == null) {
