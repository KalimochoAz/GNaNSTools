...
import mobi.cyann.gnanstools.SysCommand;
...
public abstract class BasePreference<T> extends Preference {
	private final static String LOG_TAG = "GNaNSTools.BasePreference";
	...
	public BasePreference(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.mobi_cyann_gnanstools_preference_BasePreference, defStyle, 0);
		reloadOnResume = a.getBoolean(R.styleable.mobi_cyann_gnanstools_preference_BasePreference_reloadOnResume, false);
		interfacePath = a.getString(R.styleable.mobi_cyann_gnanstools_preference_BasePreference_interfacePath);
		dependencyType = a.getInt(R.styleable.mobi_cyann_gnanstools_preference_BasePreference_dependencyType, 0);
		a.recycle();
