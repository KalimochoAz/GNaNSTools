...
import mobi.cyann.gnanstools.PreloadValues;
...
public class IoSchedPreference extends BasePreference<String> implements DialogInterface.OnClickListener {
	private final static String LOG_TAG = "GNaNSTools.IOSchedPreference";
	...
	public IoSchedPreference(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.mobi_cyann_gnanstools_preference_IoSchedPreference, defStyle, 0);
		writeToInterfaces = a.getTextArray(R.styleable.mobi_cyann_gnanstools_preference_IoSchedPreference_writeToInterface);
		a.recycle();
	}
