...
public class ListPreference extends BasePreference<Object> implements DialogInterface.OnClickListener {
	private final static String LOG_TAG = "GNaNSTools.ListPreference";
	...
	public ListPreference(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.mobi_cyann_gnanstools_preference_ListPreference, defStyle, 0);
		valueType = a.getInt(R.styleable.mobi_cyann_gnanstools_preference_ListPreference_valueType, 0);
		a.recycle();
	}
