 ...
 */
package mobi.cyann.gnanstools;

import mobi.cyann.gnanstools.PreferenceListFragment.OnPreferenceAttachedListener;
import mobi.cyann.gnanstools.services.ObserverService;
...
public class SettingFragment extends PreferenceListFragment implements OnPreferenceAttachedListener, OnPreferenceClickListener, OnPreferenceChangeListener {
	...
	public void onPreferenceAttached(PreferenceScreen rootPreference, int xmlId) {
		findPreference(getString(R.string.key_gnanstools_service)).setOnPreferenceChangeListener(this);
	...
	public boolean onPreferenceClick(Preference preference) {
		if(preference.getKey().equals(getString(R.string.key_about))) {
			...
			browse.setData(Uri.parse(getString(R.string.gnanstools_thread_url)));
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		if(preference.getKey().equals(getString(R.string.key_load_settings))) {
			...
			return true;
		}else if(preference.getKey().equals(getString(R.string.key_gnanstools_service))) {
			if(newValue != null) {
				if((Boolean)newValue) {
